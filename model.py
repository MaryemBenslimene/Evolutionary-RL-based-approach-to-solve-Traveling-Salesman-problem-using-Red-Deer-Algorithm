...
class Attention(nn.Module):
    ...
    def __init__(self, hidden_size):
        ...
        self.W = nn.Parameter(torch.rand((1, hidden_size, 3 * hidden_size),
                                          device=device, requires_grad=True))
...
class Pointer(nn.Module):
    ...
    def __init__(self, hidden_size, num_layers=1, dropout=0.2):
        ...
        self.W = nn.Parameter(torch.rand((1, hidden_size, 2 * hidden_size),
                                          device=device, requires_grad=True))
...
class DRL4TSP(nn.Module):
    ...
    def __init__(self, static_size, dynamic_size, hidden_size,
        ...
        self.x0 = torch.rand((1, static_size, 1), requires_grad=True, device=device)
